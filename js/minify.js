...
class Scene {
    ...
    clear() {
        this.ctx.fillStyle = "rgba(17, 34, 51, 0.2)",
    ...
    buildGeometry(t) {
        ...
        const c = a.measureText(e)
          , r = Math.min(.6 * h * 10 / lineHeight, .6 * s * 10 / c.width);
    ...
    nextAction() {
        this.actionIndex++,
        this.actionIndex >= this.actions.length && (this.actionIndex = this.actions.length - 1),
